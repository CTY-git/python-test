  ...
  return function (e, t, r, a) {
    function n(e) {
      ...
      b.Easings[t[0]] = l.apply(null, t[1]);
          ...
          if (e.classList) {
            t.split(" ").forEach(function(className) {
              e.classList.remove(className);
            });
          } else {
            t.split(" ").forEach(function(className) {
              e.className = e.className.replace(new RegExp('(^|\\s)' + className + '(\\s|$)', 'gi'), ' ');
            });
          }
        ...
        function e(e) {
          function p(e, t) {
            ...
            if (!i(o).tweensContainer) return void f.dequeue(o, s.queue);"none" === i(o).opts.display && (i(o).opts.display = "auto"), "hidden" === i(o).opts.visibility && (i(o).opts.visibility = "visible"), i(o).opts.loop = !1, i(o).opts.begin = null, i(o).opts.complete = null, v.easing || delete s.easing, v.duration || delete s.duration, s = f.extend({}, i(o).opts, s);var E = f.extend(!0, {}, i(o).tweensContainer);for (var H in E) {
              if ("element" !== H) {
                var N = E[H].startValue;E[H].startValue = E[H].currentValue = E[H].endValue, E[H].endValue = N, m.isEmptyObject(v) || (E[H].easing = s.easing), b.debug && console.log("reverse tweensContainer (%s): %s", H, JSON.stringify(E[H]));
